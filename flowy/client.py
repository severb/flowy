...
class SWFClient(object):
    ...
    def start_workflow(self, name, version, input):
        ...
        Returns the ``runId`` generated by Amazon that can be used to uniquely
        identify the workflow execution.  If starting the execution
        encounters an error, ``None`` is returned.
        """
        try:
